...
/**
 * Extends EclipseCompiler, enables retrieval of IProblems from compilation.
 */
class EclipseCompilerWrapper extends EclipseCompiler{
    WeakHashMap<Thread, EclipseCompilerImplWrapper> threadCache;

    EclipseCompilerWrapper(){
        super();
    }
    ...
    public CompilationTask getTask(Writer out, JavaFileManager fileManager, DiagnosticListener<? super JavaFileObject> someDiagnosticListener, Iterable<String> options, Iterable<String> classes, Iterable<? extends JavaFileObject> compilationUnits) {
        ...
        EclipseCompilerImplWrapper eclipseCompiler = this.threadCache.get(currentThread);
        	if (eclipseCompiler == null) {
			    eclipseCompiler = new EclipseCompilerImplWrapper(writerOut, writerErr, false);
            ...
            final EclipseCompilerImplWrapper eclipseCompiler2 = new EclipseCompilerImplWrapper(writerOut, writerErr, false);
